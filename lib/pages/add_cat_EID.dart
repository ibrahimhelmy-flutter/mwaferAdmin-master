...
class _CatDialogState extends State<CatDialog> {
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(hintText: "اسم الفئة"),
                        validator: (value) {
                          if (value.isEmpty) {
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(hintText: "وصف الفئة"),
                        validator: (val) {
                          if (val.isEmpty) {
                            return 'category cannot be empty';
                          } else {
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(hintText: " ادخل الرابط "),
                        validator: (val) {
                          if (val.isEmpty) {
                            return 'category cannot be empty';
                          } else {
        ...
        _uploadimages(image1, CAT_IMAGE).then((value) {
          setState(() {
            ...
            if (imgsurl.isNotEmpty) {
              uploadcat(CAT_IMAGE, imgsurl, CAT_des, coUrl);
              setState(() {
                loading = false;
              });
  ...
  void uploadcat(String cat, String imgsurl, String des, String copUrl) {
    var id = Uuid();
    ...
    try {
      _firestore
          ...
          .document(categoryId)
          .setData({'category': cat, "imgurl": imgsurl, "catDes": des,"copUrl":copUrl});
    } catch (e) {
